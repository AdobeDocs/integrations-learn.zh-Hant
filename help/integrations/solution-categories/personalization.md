  ...
  <tbody>
    ...
    <tr>
      <td>
        ...
        和Adobe [!DNL Target]進行個人化。
      </td>
      <td>
        <ul style="margin-top: 0;">
          <li>AEM網站個人化。</li>
          <li>A/B測試變數。</li>
          <li>根據使用者行為的行為目標定位。</li>
          <li>已知使用者個人化，透過拼接來自多個系統的使用者資料，提供360度全方位客戶檢視。</li>
        </ul>
      </td>
      <td>
        <a
    ...
    <tr>
      ...
      <td>
        <a
          href="https://experienceleague.adobe.com/zh-hant/perspectives/personalization-that-scales-practical-tips-for-aem-adobe-target-integration"
          target="_blank"
          rel="noopener noreferrer"
          >AEM Sites和[!DNL Target]</a
        >
