...
本節可協助有業務需求的任何人，但不確定要使用哪些Adobe應用程式以及如何整合這些應用程式。 以下是許多最常見的整合設定，依解決方案(B2B行銷、內容supply chain、資料深入分析和啟用等)進行整理。

請記住，設定Adobe應用程式有許多方式，視您的環境而定。 本節旨在提供指導，讓您可以按原樣部署或修改這些指南，以滿足您環境的需求。
...
<tr>
   <td>
      ...
      <div><strong><a href="./content-supply-chain.md">內容supply chain</a></strong></div>
      <p>
        加速內容建立和傳遞
      </p> 
    </td>
