...
+ **精確分段**：將Adobe [!DNL Analytics]與Audience Manager合併，以在行銷活動中提供個人化的對象區段。
+ **完整的客戶**&#x200B;設定檔：整合資料來源，以統一瞭解互動和行為。
+ **最佳化的廣告鎖定目標**：利用Adobe [!DNL Analytics]與Audience Manager提供的資料導向鎖定目標，增強廣告效益。
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
              <ul style="margin-top: 0;">
                <li>當您想要在Adobe [!DNL Analytics]中報告數位表單分析資料，並準備好將來與其他Experience Cloud應用程式整合時。</li>
              </ul>
            </td>
            <td>
                <ul style="margin-top: 0;">
