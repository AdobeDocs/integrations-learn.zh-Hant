...
整體而言，整合Adobe [!DNL Commerce]與Adobe [!DNL Analytics]可建立強大的電子商務生態系統，此生態系統結合資料導向的深入分析和個人化體驗，進而促進客戶參與度、提升銷售額及整體業務成長。
        ...
        <tr>
            ...
            <td>
                <ul style="margin-top: 0;">
                    <li>Adobe中安裝的模組 [!DNL Commerce]</li>
            ...
            <td>
                <ul style="margin-top: 0;">
                    <li>當您想要確保完整瞭解商店的整體效能時。 更具體來說，適用於[!DNL Commerce] Intelligence的Adobe [!DNL Analytics]整合可讓商家開始合併其Adobe [!DNL Commerce]與Adobe [!DNL Analytics]資料集。</li>
                </ul>
            </td>
            <td>
                <ul style="margin-top: 0;">
