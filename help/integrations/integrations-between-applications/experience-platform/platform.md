...
Adobe Experience [!DNL Platform]是市面上功能最強大、最靈活、最開放的系統，可建置和管理可提升客戶體驗的完整解決方案。 許多新的Adobe應用程式已建置在Experience [!DNL Platform]之上，包括：
...
* [使用Audience Manager](../rtcdp/rtcdp-aam.md)
