...
將Adobe [!DNL Analytics]與Customer Journey [!DNL Analytics]整合可提供主要優點：
        ...
        <tr>
            ...
            <td>
                <ul style="margin-top: 0;">
                    <li>建議已實作Adobe [!DNL Analytics]且想要以最快方式將此資料擷取至體驗[!DNL Platform]，以便用於客戶歷程[!DNL Analytics]的客戶使用。</li>
